uiroute.controller('AdminHotelController', function ($scope, $http, FileUploadService, FileRoomUploadService) {
    ...
    $scope.InsertAdminResidence = function (data) {
    ...
    $scope.InsertResidence = true;
    $scope.OpenInsertResidence = function () {
        $scope.InsertResidence = $scope.InsertResidence ? false : true;
    };
    ...
    $scope.InsertAdminHotel = function (data) {
        $scope.Hotel = data;
    ...
    $scope.InsertHotel = true;
    $scope.OpenInsertHotel = function () {
        $scope.InsertHotel = $scope.InsertHotel ? false : true;
    };
    ...
    $scope.InsertAdminRoom = function (data) {
        $scope.Room = data;
    ...
    $scope.InsertRoom = true;
    $scope.OpenInsertRoom = function () {
        $scope.InsertRoom = $scope.InsertRoom ? false : true;
    };
