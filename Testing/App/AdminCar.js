uiroute.controller('AdminCar', function ($scope, $http, FileUploadService) {
    ...
    GetAllCars();
    function GetAllCars() {
        $http.get($scope.BaseUrl + '/Cars').then(function (response) { /*alert("Succesfull!");*/ $scope.Cars = response.data; }, function () { alert("Failed To Get"); });
    }
    ...
    function GetAllSuppliers() {
        $http.get($scope.BaseUrl + '/Suppliers').then(function (response) { /*alert("Succesfull!");*/ $scope.Suppliers = response.data; }, function () { alert("Failed To Get"); });
    }
    ...
    $scope.InsertSupplier = function (data) {
        $scope.Supplier = data;
